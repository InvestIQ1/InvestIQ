            ...
            <div className="auth-page__right">
                <form className="auth-form">
                    <p className="auth-form__social-text">
                        Ви можете зареєструватися за допомогою Google або GitHub
                    </p>
                    <div className="auth-form__social-buttons">
                        <button className="auth-form__social-button" type="button">
                            ...
                            >
                                <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.7 32.7 29.3 36 24 36c-6.6 0-12-5.4-12-12S17.4 12 24 12c3 0 5.8 1.1 7.9 2.9l5.7-5.7C34.1 6.1 29.3 4 24 4 13 4 4 13 4 24s9 20 20 20 20-9 20-20c0-1.3-.1-2.4-.4-3.5z" />
                                ...
                                <path fill="#4CAF50" d="M24 44c5.2 0 10-2 13.5-5.3l-6.2-5.2C29.2 35.1 26.7 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.6 5.1C9.5 39.6 16.2 44 24 44z" />
                                <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-1.1 3.1-3.3 5.5-6.2 7l6.2 5.2C39 36.9 44 31 44 24c0-1.3-.1-2.4-.4-3.5z" />
                            </svg>
                            Google
                        </button>
                        <button className="auth-form__social-button" type="button">
                    ...
                    <div className="auth-form__divider">
                        <p className="auth-form__social-text">Або зареєструйтеся за допомогою ел. пошти та паролю</p>
                    </div>
